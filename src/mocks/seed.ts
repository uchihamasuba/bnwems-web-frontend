  ...
  return {
    customers: [
      ...
      },
      {
        ...
        phone: '0988123456',
        email: 'nam.nh@email.vn',
        address: 'Tòa nhà ABC, Quận 7, TP. HCM',
...
function createInitialOrderStore(): OrderMockStore {
  return {
    orders: [
      ...
      {
        id: 'order-6',
        orderNumber: 'ORD-2023-9022',
        customerId: 'cust-3',
        eventDate: '2023-11-02T00:00:00Z',
        venueAddress: 'Khách sạn Majestic, Quận 1',
        status: 'IN_PROGRESS',
      ...
      {
        id: 'order-7',
        orderNumber: 'ORD-2023-8810',
        customerId: 'cust-3',
        eventDate: '2023-06-18T00:00:00Z',
        venueAddress: 'Gem Center, Quận 1',
        status: 'COMPLETED',
  ...
  return {
    quotations: [
      ...
      },
      {
        ...
        details: {
          items: [{ catalogItemId: 'item-1', quantity: 10, price: 5000000 }],
        },
        status: 'ACCEPTED',
      ...
      },
      {
        ...
        details: {
          items: [{ catalogItemId: 'item-2', quantity: 2, price: 40000000 }],
        },
        status: 'ACCEPTED',
