...
function QuotationFormContent() {
  ...
  const [selectedCustomerId, setSelectedCustomerId] = useState(
    () => customers.find((c) => existing && c.phone === existing.customerPhone)?.customerId ?? '',
  );
  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-6 overflow-x-auto rounded-xl border border-slate-200 bg-white p-4 shadow-xs">
