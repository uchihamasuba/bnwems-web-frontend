...
// Trang thuần giao diện — xem giải thích ở đầu src/mocks/adminSchedulePlansMock.ts. Chỉ giữ 2 view
// (Lịch điều phối + Danh sách kế hoạch) theo yêu cầu người dùng — bỏ view Kanban của file mẫu
// docs/components/PlanningSection.tsx.
...
function AdminPlanningPageContent() {
