...
export default function OrderPaymentDetailPage() {
  ...
  if (!order) {
    return (
      <div className="p-6">
        ...
        <Link href="/manager/payments/deposits" className="mt-2 inline-block text-sm font-medium text-blue-600 hover:underline">
          Quay lại danh sách
        </Link>
      </div>
    );
  ...
  return (
    <div className="p-6">
      <Link href="/manager/payments/deposits" className="mb-4 inline-flex items-center gap-1.5 text-sm font-medium text-slate-500 hover:text-blue-600">
