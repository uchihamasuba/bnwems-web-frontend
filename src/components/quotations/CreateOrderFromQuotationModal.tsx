...
import { AdminQuotationRow, ITEM_CATEGORY_OPTIONS } from '@/mocks/adminQuotationsMock';
import { AdminOrderLineItem, COORDINATOR_POOL, PACKAGE_OPTIONS, VENUE_OPTIONS } from '@/mocks/adminOrdersMock';
...
// thành xem lại (không phải bộ chọn) vì đã biết sẵn khách hàng/báo giá. Theo đúng hành vi trang gốc,
// bước 5 KHÔNG gọi addAdminOrder/tạo Order thật — chỉ minh hoạ luồng thao tác rồi đóng popup.
